...
public class BookingAdapter extends RecyclerView.Adapter<BookingAdapter.BookingViewHolder> {
    ...
    public void onBindViewHolder(@NonNull BookingViewHolder holder, int position) {
        ...
        // ➤ Ενεργοποίηση ακύρωσης μόνο για renters όταν είναι PENDING
        ...
        // ➤ Ενέργειες admin μόνο όταν είναι PENDING
        if (isAdmin && booking.getStatus() == Status.PENDING) {
        ...
        // ➤ Αναφορά διαφωνίας (διαθέσιμο για όλους)
        holder.disputeBtn.setOnClickListener(v -> {
            Intent intent = new Intent(v.getContext(), RaiseDisputeActivity.class);
            intent.putExtra("bookingIndex", position); // ή .putExtra("bookingId", booking.getBookingID())
